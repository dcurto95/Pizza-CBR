...
# ingredient_label = Label(ingredients_frame, text="Select the ingredients you want", font=section_font)
# ingredient_label.grid(row=0, column=0, ipadx=10, ipady=10)
#
#
# # #Create frame and scrollbar
...
#
# #Label Select ingredients
# ingredients_discarded_frame = Frame(root)
# ingredient_discarded_label = Label(ingredients_discarded_frame, text="Select the ingredients you do not want", font=section_font)
# ingredient_discarded_label.grid(row=0, column=0, ipadx=10, ipady=10)
#
#
# # #Create frame and scrollbar
...
#
# #SAUCES
# sauces_frame = Frame(root)
#
# #Label select sauces
# sauces_label = Label(sauces_frame, text="Select the sauces you want", font=section_font)
# sauces_label.grid(column=0, row=0, columnspan=2, ipadx=5, ipady=5, sticky="NSEW")
#
#
# #Dropdown sauces
...
#
# #Label Select Dough
# dough_label = Label(root, text="Select the dough", font=section_font)
# dough_label.grid(row=2, columnspan=2)
#
# #Dropdown dough
# dough_types = KnowledgeBase.dough
...
#
# #Button generate recipte
# add_btn = Button(root, text="Generate recipe", command=generate_recipe)
# add_btn.grid(row=4, columnspan=2, ipadx=5, ipady=5, pady=20)
#
#
# root.mainloop()
